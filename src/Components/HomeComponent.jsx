            ...
            <div className="body">
                <div>
                    <div className="userInfoTable">
                        ...
                        {rc_user_userInfoValue && (
                            <>
                                {Object.keys(rc_user_userInfoValue.data).map(
                                    (item, idx) => (
                        ...
                        {/* 소셜 서비스 사용자 정보 */}
                        {rc_user_userInfoValue.data.loginType === "kakao" && (
                            <>
                                <div className="infoBox infoBox_Header">
                                    <div>카카오 정보</div>
                                </div>
                                ...
                                <div className="infoBox">
                                    <div>id </div>
                                    <div>
                                        {rc_user_userInfoValue.socialData.id}
                                    </div>
                                </div>
                                {Object.keys(
                                    rc_user_userInfoValue.socialData
                                ...
                                {Object.keys(
                                    rc_user_userInfoValue.socialData.properties
                                ).map((item, idx) => (
                                    <div key={idx} className="infoBox">
                                        <div>{item} </div>
                                        <div>
                        ...
                        {/* 소셜 서비스 사용자 정보 */}
                        {rc_user_userInfoValue.data.loginType === "google" && (
                            <>
                                <div className="infoBox infoBox_Header">
                                    <div>구글 정보</div>
                                </div>
